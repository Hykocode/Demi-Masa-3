    ...
    <section class="container mr-auto px-4 py-16">
        <div class="max-w-3xl mx-auto text-left">
            ...
            <span>!</span>
                ...
                <button id="registerBtn" class=" px-6 py-3 rounded-lg text-lg "  ><p >Daftar Sekarang!</p></button>
    ...
    <div id="loginModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg p-8 max-w-md w-full">
            ...
            <form id="loginForm">
                ...
                <button type="submit" class="w-full  text-white py-2 rounded-lg  transition">Login</button>
            </form>
        ...
        <div class="bg-white rounded-lg p-8 max-w-md w-full">
            ...
            <div id="registerStep2" class="hidden">
                ...
                <form id="otpVerificationForm">
                    ...
                    <button type="button" id="resendOtp" class="w-full mt-2 bg-white text-white border border-indigo-600 py-2 rounded-lg hover:bg-indigo-50 transition">Resend Code</button>
                </form>
            </div>
